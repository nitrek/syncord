...
export class SyncordService {
  ...
  currentBanker = "BARCLAYS";
  userName = "Smith Jones";
  baseUrl = "http://ec2-52-76-64-110.ap-southeast-1.compute.amazonaws.com:10010/api/syncord";
  ...
  public GET_MY_ORDERS = 'http://ec2-52-76-64-110.ap-southeast-1.compute.amazonaws.com:5000/barclays';
